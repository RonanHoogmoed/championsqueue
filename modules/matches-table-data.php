<div class="row g-0 mb-4 rounded-bottom match" id="match-<?php echo $matchcount; ?>" >
            ...
            foreach ($matches['matches'][$matchcount]['teams'][0]['players'] as &$value) {
                echo '<table class="table mb-0">';
                    ...
                    echo '<tr class="' . $winnerstatus . '">';
                        ...
                        echo '<td class="text-end">' . $matches['matches'][$matchcount]['teams'][0]['players'][$playercount]['cs'] . '</td>';
                    echo '</tr>';
                echo '</table>';
        ...
        <?php
            ...
            foreach ($matches['matches'][$matchcount]['teams'][1]['players'] as &$value) {
                echo '<table class="table mb-0">';
                    ...
                    echo '<td class="font-weight-bold text-end" style="width: 30%;">' . $team1player . '</td>';
                    echo '</tr>';
                echo '</table>';
                $playercount = $playercount + 1;
            }
